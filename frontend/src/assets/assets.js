...
export const messagesDummyData = [
    {
        ...
        "text": "The source provides an extensive technical overview of the end-to-end architecture powering the GPT-5 language model, detailing the complex workflow from user input to streamed output.",
        "seen": true,
    ...
    },
    {
        ...
        "text": "Sir we decided to go with the CT scan and we chose the organ 'brain'.",
        "seen": true,
    ...
    },
    {
        ...
        "senderId": "680f5116f10f3cd28382ed02",
        "receiverId": "680f50e4f10f3cd28382ecf9",
        "text": "Sir, I have mailed you the updated link for the report. We tried to remove the plagiarism and AI from it. And also added some visual representations as you asked. Can you please check if it is ok or not.",
        "seen": true,
    ...
    },
    {
        ...
        "senderId": "680f50e4f10f3cd28382ecf9",
        "receiverId": "680f5116f10f3cd28382ed02",
        "text": "Also, during the selection period, we came across this paper. Also, sir, can we meet you regarding this tomorrow",
        "seen": true,
